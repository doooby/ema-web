...
export function recordControls ({
  ...
  return [
    ...
    [ 'education_types', controls.selectMultiple, { options: countryData?.options.records.schools.education_types() } ],
    [ 'gender_dedications', controls.selectMultiple, { options: countryData?.options.records.schools.gender_dedications() } ],
